...
- [3. Java基本数据类型](#3-java------)
  * [3.1 基本数据类型的包装类](#31-----------)
  * [3.2 short s1 = 1;s1 = s1 + 1；有什么错？short s1 = 1; s1 += 1; 有什么错？](#32-short-s1---1-s1---s1---1------short-s1---1--s1----1-------)
  * [3.3 String转出int类型，判断能不能转？如何转？](#33-string--int--------------)
  * [3.4 Int 与 Integer 的区别](#34-int---integer----)
  * [3.5 字节与字符的区别](#35---------)
- [4. equal 与 == 的区别](#4-equal---------)
- [5. String、StringBuffer、StringBuilder、hashcode、equal](#5-string-stringbuffer-stringbuilder-hashcode-equal)
- [6. 文件读取](#6-----)
- [7. Java反射](#7-java--)
- [8. static 与 final 的区别](#8-static---final----)
- [9. map、list、set 的区别](#9-map-list-set----)
- [10. Session 和 Cookie 的区别](#10-session---cookie----)
- [11. IO NIO BIO AIO select epoll](#11-io-nio-bio-aio-select-epoll)
  * [11.1 NIO 的原理](#111-nio----)
